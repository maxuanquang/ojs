...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OjsProto.OjsCreateTestCaseRequest();
  });
  ...
  describe('OjsCreateTestCaseRequest', function() {
    it('should create an instance of OjsCreateTestCaseRequest', function() {
      // uncomment below and update the code to test OjsCreateTestCaseRequest
      //var instance = new OjsProto.OjsCreateTestCaseRequest();
      //expect(instance).to.be.a(OjsProto.OjsCreateTestCaseRequest);
    });
