...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OjsProto.OjsServiceUpdateTestCaseBody();
  });
  ...
  describe('OjsServiceUpdateTestCaseBody', function() {
    it('should create an instance of OjsServiceUpdateTestCaseBody', function() {
      // uncomment below and update the code to test OjsServiceUpdateTestCaseBody
      //var instance = new OjsProto.OjsServiceUpdateTestCaseBody();
      //expect(instance).to.be.a(OjsProto.OjsServiceUpdateTestCaseBody);
    });
