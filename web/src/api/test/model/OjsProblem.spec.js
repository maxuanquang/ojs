...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OjsProto.OjsProblem();
  });
  ...
  describe('OjsProblem', function() {
    it('should create an instance of OjsProblem', function() {
      // uncomment below and update the code to test OjsProblem
      //var instance = new OjsProto.OjsProblem();
      //expect(instance).to.be.a(OjsProto.OjsProblem);
    });
